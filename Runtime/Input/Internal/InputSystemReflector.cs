...
namespace RealPlayTester.Input.Internal
{
    ...
    internal static class InputSystemReflector
    {
        ...
        internal static readonly MethodInfo QueueStateEventKeyboard = GetQueueStateEventGeneric(Types.KeyboardState);
        internal static readonly MethodInfo QueueStateEventMouse = GetQueueStateEventGeneric(Types.MouseState);
        internal static readonly MethodInfo QueueStateEventGamepad = GetQueueStateEventGeneric(Types.GamepadState);
        
        internal static readonly MethodInfo KeyboardStateSetMethod = Types.KeyboardState != null && Types.KeyEnum != null
            ? Types.KeyboardState.GetMethod("Set", new[] { Types.KeyEnum, typeof(bool) })
            : null;

        internal static readonly PropertyInfo KeyboardCurrentProperty = Types.Keyboard != null
            ? Types.Keyboard.GetProperty("current", BindingFlags.Public | BindingFlags.Static)
            : null;

        internal static readonly PropertyInfo KeyboardItemProperty = Types.Keyboard != null && Types.KeyEnum != null
            ? Types.Keyboard.GetProperty("Item", new[] { Types.KeyEnum })
            : null;

        internal static readonly PropertyInfo WasPressedThisFrameProperty = Types.KeyControl != null
            ? Types.KeyControl.GetProperty("wasPressedThisFrame", BindingFlags.Public | BindingFlags.Instance)
            : null;
            
        internal static readonly PropertyInfo MouseCurrentProperty = Types.Mouse != null
            ? Types.Mouse.GetProperty("current", BindingFlags.Public | BindingFlags.Static)
            : null;

        internal static readonly MethodInfo AddDeviceMethod = Types.InputSystem != null
            ? Types.InputSystem.GetMethod("AddDevice", new[] { typeof(Type) })
            : null;

        internal static readonly MethodInfo UpdateMethod = Types.InputSystem != null && Types.InputUpdate != null
            ? Types.InputSystem.GetMethod("Update", BindingFlags.Public | BindingFlags.Static, null, new[] { Types.InputUpdate }, null)
            : null;

        internal static readonly MethodInfo UpdateMethodNoArgs = Types.InputSystem != null
